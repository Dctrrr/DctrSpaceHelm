        ...
        if (sender instanceof Player) {
            ...
            if (player.hasPermission("adminitem.spacehelm")) {
                ...
                itemMeta.setLore(Arrays.asList(
                        ...
                        " ",
                        ChatColor.DARK_GRAY + "To: " + ChatColor.GRAY + PlaceholderAPI.setPlaceholders(player, "%vault_rank%") + PlaceholderAPI.setPlaceholders(player, "%player_name%"),
                        ChatColor.DARK_GRAY + "From: " + ChatColor.RED + PlaceholderAPI.setPlaceholders(player,"%vault_rank%") + PlaceholderAPI.setPlaceholders(player, "%player_name%"),
                        " ",
