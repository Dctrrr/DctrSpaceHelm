        ...
        if (sender instanceof Player) {
            ...
            if (player.hasPermission("adminitem.spacehelm")) {
                ...
                itemMeta.setLore(Arrays.asList(
                        ...
                        " ",
                        ChatColor.RESET + "" + ChatColor.GRAY + "To: " + PlaceholderAPI.setPlaceholders(player,  " %vault_rankprefix% ") + player.getDisplayName(),
                        ChatColor.RESET + "" + ChatColor.GRAY + "From: " + PlaceholderAPI.setPlaceholders(player, " %vault_rankprefix% ") + ((Player)sender).getDisplayName(),
                        " ",
